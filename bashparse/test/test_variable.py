...
class TestVariables(TestCase):
    ...
    def test_update_variable_list_with_node(self):
        ...
        self.assertTrue(new_var_list == {'n':['one two three'], 'a':['for_loop$n']})
