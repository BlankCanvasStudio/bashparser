...
class TestAst(TestCase):
	...
	def test_return_paths_to_node_type(self):
		...
		expected_results = [
			"path_var([0,0,1], WordNode(parts=[] pos=(4, 5) word='a'))",
			"path_var([0,0,3], WordNode(parts=[ParameterNode(pos=(9, 11) value='n')] pos=(9, 11) word='$n'))", 
			"path_var([0,0,5,0,0], WordNode(parts=[] pos=(18, 22) word='wget'))", 
			"path_var([0,0,5,0,1], WordNode(parts=[] pos=(23, 27) word='that'))",
			"path_var([0,0,5,2,0], WordNode(parts=[] pos=(30, 32) word='cd'))", 
			"path_var([0,0,5,2,1], WordNode(parts=[] pos=(33, 38) word='there'))", 
			"path_var([0,0,5,4,0], WordNode(parts=[] pos=(41, 43) word='mv'))",
			"path_var([0,0,5,4,1], WordNode(parts=[] pos=(44, 48) word='here'))", 
		]
